...
steps=[["1e7","3e7","1e8","3e8","1e9","3e9","1e10","3e10","1e11","3e11"],["average.sfe","fast.sfe","slow.sfe"],[True,False],["Salp"],[0.5],[0.15],[1,5,20,80],[0,15,30],[0.05],[1000,2000,4000,8000,16000],[0,5,10],\
[0.25],[0.2,0.3,0.4],["tot_LC18_R150"],['KA18_high']]
#steps=[["1e7","3e7","1e8","3e8","1e9","3e9","1e10","3e10","1e11","3e11"],["average.sfe"],[False],["Salp"],[0.5],[0.15],[2.01],[15.74],[0.03],[3820],[5.59],[1.],[0.204],["tot_LC18_R150"],['KA18_high']]
...
'''
outtable=open("modelGrid_dust_IZI.csv","w")   		
