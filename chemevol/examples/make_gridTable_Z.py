...
steps=[["1e7","3e7","1e8","3e8","1e9","3e9","1e10","3e10","1e11","3e11","1e12"],["average.sfe","fast.sfe","slow.sfe"],[True,False],["Chab","Salp","TopChab","Kroup"],[0.5],[0.15],[5],[15],[0.5],[4000],[5],\
[2.,1.,0.5,0.25,0.1],[0.3],["tot_LC18_R000","tot_LC18_R150","tot_LC18_R300","MA92_ori_extra","MM02_000"],['Nugrid','FRUITY','KA18_low','KA18_high','KA10','VG97']]
