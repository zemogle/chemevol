...
inits = [
		...
		{	'name': 'Model_III_test',
			...
			'destroy': {'on': False, 'mass': 0},
			'inflows':{'on': False, 'metals': 0., 'xSFR': 0, 'dust': 0},
			'outflows':{'on': True, 'metals': True, 'xSFR': 1.5,'dust': True},
			'cold_gas_fraction': 0.5,
			'epsilon_grain': 0},
		...
		{	'name': 'Model_IV_test',
			...
			'outflows':{'on': True, 'metals': False, 'xSFR': 1.5,'dust': False},
			'cold_gas_fraction': 0.5,
			'epsilon_grain': 800},
		...
		{	'name': 'Model_V_test',
			...
			'inflows':{'on': True, 'metals': 0., 'xSFR': 2.0, 'dust': 0},
			'outflows':{'on': True, 'metals': False, 'xSFR': 2.0,'dust': False},
			'cold_gas_fraction': 0.5,
			'epsilon_grain': 6000},
