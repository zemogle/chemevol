...
|   destroy 	       |	 on: add dust destruction from SN shocks: True or False <br><br>
                         mass: amount of material destroyed by each supernova, typically 1000 or 100Msun for diffuse or dense interstellar gas    |   None   |
